...
from ._utils import pagination_factory, schema_factory, delete_schema_factory
...
class CRUDGenerator(Generic[T], APIRouter, ABC):
    ...
    def __init__(
            ...
            delete_schema: Optional[Type[T]] = None,
        ...
        self._del: str = self._del if hasattr(self, "_del") else "delete_status"
        self.create_schema = (
            create_schema
            if create_schema
