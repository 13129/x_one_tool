...
class DkDnsRouter:
    ...
    async def overloaded_dk_dns_get_one(self, item_id=None):
        query = select(self.router.db_model).options(
...
class DkTableRouter:
    ...
    async def overloaded_dk_table_get_one(self, item_id=None):
        query = select(self.router.db_model).options(
...
class DkCatalogRouter:
    ...
    async def overloaded_dk_catalog_get_all(self):
        query = select(self.router.db_model).options(
    ...
    async def overloaded_dk_catalog_get_all(self, item_id: str = None):
        query = select(self.router.db_model).options(
